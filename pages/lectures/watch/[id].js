import {getUploadPlaylistVideos, getRelatedYoutubeVideoListByUrl, getYoutubeVideoDetailsByUrl} from '../../../lib/fetch'
                            ...
                            <div className="video-wrap-outer">
                                <div className="video-wrap">
                                    <div className="video-wrap-image" ref={preImage}>
                                        <button onClick={handleLoadIframe}><PlayIcon /></button>
                                        <Image
                                            //src={image ? image : '/img/post/youtube-default.jpg'}
                                            src={image ? `http://i.ytimg.com/vi/${id}/maxresdefault.jpg` : `${server}/img/post/youtube-default.jpg`}
                                            alt=""
                                            layout="fill"
                                            objectFit="cover"
                            ...
                            <div className="blog-detail">
                                <div className="row row-r video-title-area">
                                    <div className="col col-r s12 l9">
                                        <div><h2 className="margin-bottom-0">{ title }</h2></div>
